...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-09-2024 a las 18:47:55
...
--
ALTER TABLE `productos`
  MODIFY `id_productos` int(200) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `detalle_compras`
  ADD CONSTRAINT `detalle_compras_ibfk_1` FOREIGN KEY (`id_productos`) REFERENCES `productos` (`id_productos`);
...
ALTER TABLE `reseñas`
  ...
  ADD CONSTRAINT `reseñas_ibfk_2` FOREIGN KEY (`id_productos`) REFERENCES `productos` (`id_productos`);
